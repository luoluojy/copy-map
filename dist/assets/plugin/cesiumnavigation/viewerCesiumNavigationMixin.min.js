(function (root, factory) {
  ...
  define("ViewModels/ResetViewNavigationControl", ["Cesium/Core/defined", "Cesium/Scene/Camera", "Cesium/Core/Cartesian3", "Cesium/Core/Rectangle", "Cesium/Core/Cartographic", "ViewModels/NavigationControl", "SvgPaths/svgReset"], function (defined, Camera, Cartesian3, Rectangle, Cartographic, NavigationControl, svgReset) {
    "use strict";
    ...
    ResetViewNavigationControl.prototype.resetView = function () {
      ...
      if (defined(this.terria.trackedEntity)) {
        ...
        if (this.terria.options.defaultResetView) {
          ...
          }else if (this.terria.options.defaultResetView && this.terria.options.defaultResetView instanceof Cartesian3) {
            try {
